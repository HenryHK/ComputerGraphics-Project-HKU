...
private:
	virtual void updateTextureCoordinate( Ray3D&, const Matrix4x4& ) = 0;
};
...
private:
	void updateTextureCoordinate(Ray3D& ray, const Matrix4x4& worldToModel);
};
...
private:
	void updateTextureCoordinate(Ray3D& ray, const Matrix4x4& worldToModel); //not update yet
};